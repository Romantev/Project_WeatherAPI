...
const Schierstein = () => {
  const city = "Wiesbaden-Schierstein";
  ...
  useEffect(() => {
    fetch(
      `https://api.openweathermap.org/data/2.5/weather?lat=50.041969&lon=8.193998&lang=de&units=metric&appid=${API_KEY}`
    )
      .then((res) => res.json())
      .then((data) => {
        setData(data);
